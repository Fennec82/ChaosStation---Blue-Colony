...
var/global/list/playable_species = list(SPECIES_HUMAN, SPECIES_UNATHI, SPECIES_TAJ, SPECIES_SKRELL, SPECIES_TESHARI)    // A list of ALL playable species, whitelisted, latejoin or otherwise.
